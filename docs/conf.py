# -*- coding: utf-8 -*-
#
# napari-stracking documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../napari_stracking'))
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-stracking Documentation',
     [author], 1)
]
